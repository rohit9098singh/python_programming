...
for i,j in enumerate(new_list,start=1):#end function is not supported in enummerator we will have to explicitly use if to itterate over the list as per our start and end
     if 1 <= i <= 2:
